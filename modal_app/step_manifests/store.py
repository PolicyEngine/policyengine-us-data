...
def build_run_manifest(meta: RunMetadata) -> RunManifest:
    ...
    return RunManifest(
        ...
        base_release_version=meta.base_release_version,
        release_bump=meta.release_bump,
        status=meta.status,
...
def run_manifest_to_metadata(manifest: RunManifest) -> RunMetadata:
    ...
    return RunMetadata(
        ...
        base_release_version=manifest.base_release_version,
        release_bump=manifest.release_bump,
