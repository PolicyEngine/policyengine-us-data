...
def _release_metadata_rows(
    ...
    artifacts = (
        ...
        (
            ...
            f"releases/{context.release_version}/release_manifest.json",
            "release_manifest",
            "application/json",
        ),
        ("trace_tro", "trace.tro.jsonld", "trace_tro", "application/ld+json"),
        (
            "versioned_trace_tro",
            f"releases/{context.release_version}/trace.tro.jsonld",
            "trace_tro",
            "application/ld+json",
        ),
        (
    ...
    return tuple(
        ...
        for logical_name, relative_path, artifact_family, media_type in artifacts
    )
